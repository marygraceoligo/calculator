...
<div class="container">
<header>
    <a href="#"><img src="img/cal2.png" alt="" width="80" height="80" id="Insert_logo" style="background-color: #C6D580; display:block;" /></a>
  </header>
...
background-image: url('img/cal3.jpg');}
</style>
...
<form>
	Num1: <input type="text" name="num1" placeholder="Number1"><br>
	Num2: <input type="text" name="num2" placeholder="Number2"><br><br>
	...
	<br>
	<br>
	<button type="submit" name="submit" value="submit" ><h3><br>Calculate</button>
</form>	
<br>
<p>The answer is:</p>
<?php
